...
<div  id="myDiv">
    <center>
         ...
         <h1>Incremento de pedidos por mes, cada año</h1>
         </center>
        <div class="caja">
    ...
    <div class="explanation">
       <p>En el presente grafico, tenemos la representacion grafica del crecimiento de la cantidad de pedidos totales durante cada mes. Si presionamos el cuadro relacionado a los años, tendremos una representacion grafica del crecimiento de la cantidad de pedidos referentes al año seleccionado.</p>
     </div>
</div>
</div>
        <center>
